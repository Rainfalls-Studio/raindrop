...
/// (pdf file)</a>.
///
/// GLM core functionalities require <Core/Maths/glm.hpp> to be included to be used.
///
///
...
/// including <Core/Maths/ext.hpp>. Otherwise, each extension needs to be included  a specific file.
///
///
...
/// at once by including <Core/Maths/ext.hpp>. Otherwise, each extension needs to be
