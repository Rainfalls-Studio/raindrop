...
namespace detail
{
	GLM_FUNC_QUALIFIER Raindrop::Core::Math::uint16 float2half(Raindrop::Core::Math::uint32 f)
	{
		// 10 bits    =>                         EE EEEFFFFF
	...
	GLM_FUNC_QUALIFIER Raindrop::Core::Math::uint32 float2packed11(Raindrop::Core::Math::uint32 f)
	{
		// 10 bits    =>                         EE EEEFFFFF
		// 11 bits    =>                        EEE EEFFFFFF
		// Half bits  =>                   SEEEEEFF FFFFFFFF
	...
	GLM_FUNC_QUALIFIER Raindrop::Core::Math::uint32 packed11ToFloat(Raindrop::Core::Math::uint32 p)
	{
		// 10 bits    =>                         EE EEEFFFFF
		// 11 bits    =>                        EEE EEFFFFFF
		// Half bits  =>                   SEEEEEFF FFFFFFFF
	...
	GLM_FUNC_QUALIFIER Raindrop::Core::Math::uint32 float2packed10(Raindrop::Core::Math::uint32 f)
	{
		// 10 bits    =>                         EE EEEFFFFF
		// 11 bits    =>                        EEE EEFFFFFF
		// Half bits  =>                   SEEEEEFF FFFFFFFF
	...
	GLM_FUNC_QUALIFIER Raindrop::Core::Math::uint32 packed10ToFloat(Raindrop::Core::Math::uint32 p)
	{
		// 10 bits    =>                         EE EEEFFFFF
		// 11 bits    =>                        EEE EEFFFFFF
		// Half bits  =>                   SEEEEEFF FFFFFFFF
	...
	GLM_FUNC_QUALIFIER Raindrop::Core::Math::uint half2float(Raindrop::Core::Math::uint h)
	{
		return ((h & 0x8000) << 16) | ((( h & 0x7c00) + 0x1C000) << 13) | ((h & 0x03FF) << 13);
	}

	GLM_FUNC_QUALIFIER Raindrop::Core::Math::uint floatTo11bit(float x)
	{
		if(x == 0.0f)
			return 0u;
		else if(Raindrop::Core::Math::isnan(x))
			return ~0u;
		else if(Raindrop::Core::Math::isinf(x))
			return 0x1Fu << 6u;
	...
	GLM_FUNC_QUALIFIER float packed11bitToFloat(Raindrop::Core::Math::uint x)
	{
		if(x == 0)
			return 0.0f;
		else if(x == ((1 << 11) - 1))
	...
	GLM_FUNC_QUALIFIER Raindrop::Core::Math::uint floatTo10bit(float x)
	{
		if(x == 0.0f)
			return 0u;
		else if(Raindrop::Core::Math::isnan(x))
	...
	GLM_FUNC_QUALIFIER float packed10bitToFloat(Raindrop::Core::Math::uint x)
	{
		if(x == 0)
			return 0.0f;
		else if(x == ((1 << 10) - 1))
...
//	GLM_FUNC_QUALIFIER Raindrop::Core::Math::uint f11_f11_f10(float x, float y, float z)
//	{
...
//	}
	...
	GLM_FUNC_QUALIFIER uint64 packHalf4x16(Raindrop::Core::Math::vec4 const& v)
	{
	...
	GLM_FUNC_QUALIFIER Raindrop::Core::Math::vec4 unpackHalf4x16(uint64 v)
	{
		i16vec4 Unpack;
		memcpy(&Unpack, &v, sizeof(Unpack));
		return vec4(
