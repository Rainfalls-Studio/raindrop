...
namespace detail
{
	...
	struct compute_findLSB
	{
		GLM_FUNC_QUALIFIER static int call(genIUType Value)
		{
			...
			return Raindrop::Core::Math::bitCount(~Value & (Value - static_cast<genIUType>(1)));
		}
	};
...
#	endif//GLM_HAS_BITSCAN_WINDOWS
	...
	struct compute_findMSB_vec
	{
		GLM_FUNC_QUALIFIER static vec<L, int, Q> call(vec<L, T, Q> const& v)
		{
			...
			return vec<L, int, Q>(sizeof(T) * 8 - 1) - Raindrop::Core::Math::bitCount(~x);
		}
	};
...
#	endif//GLM_HAS_BITSCAN_WINDOWS
	...
	GLM_FUNC_QUALIFIER genIUType bitfieldReverse(genIUType x)
	{
		...
		return bitfieldReverse(Raindrop::Core::Math::vec<1, genIUType, Raindrop::Core::Math::defaultp>(x)).x;
	}
	...
	GLM_FUNC_QUALIFIER int bitCount(genIUType x)
	{
		...
		return bitCount(Raindrop::Core::Math::vec<1, genIUType, Raindrop::Core::Math::defaultp>(x)).x;
	}
